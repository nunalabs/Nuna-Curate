...
const nextConfig = {
      ...
      config.optimization = {
        ...
        splitChunks: {
          ...
          cacheGroups: {
            ...
            // Stellar SDK chunk (large library)
            stellar: {
              name: 'stellar',
  ...
  experimental: {
    // optimizeCss: true,  // Disabled for development (requires critters package)
    optimizePackageImports: ['lucide-react', '@radix-ui/react-icons'],
  },

  // Output mode for Docker deployment
  // This creates a minimal standalone build for production
